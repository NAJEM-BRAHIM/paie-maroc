...
class AttendanceReportWizard(models.TransientModel):
    ...
    def export_attendance_xlsx(self, fl=None):
        ...
        if self.report_from == 'log':
            # date_from = self.convert_timezone(self.date_from)
            # date_to = self.convert_timezone(self.date_to)
    ...
    def print_attendance_records(self, attendances):
        ...
        # str_date1 = self.convert_timezone(self.date_from)
        ...
        # str_date2 = self.convert_timezone(self.date_to)
